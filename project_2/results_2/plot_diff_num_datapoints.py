...
models = {
    ...
    "ViT_S16": {
        "2000": "vit_s16_2000_metrics_diff_num_datapoints.csv",
        "4000": "vit_s16_4000_metrics_diff_num_datapoints.csv",
        "6000": "vit_s16_6000_metrics_diff_num_datapoints.csv",
        "8000": "vit_s16_8000_metrics_diff_num_datapoints.csv",
        "10000": "vit_s16_10000_metrics_diff_num_datapoints.csv",
        "12000": "vit_s16_12000_metrics_diff_num_datapoints.csv",
        "14000": "vit_s16_14000_metrics_diff_num_datapoints.csv",
        "16000": "vit_s16_16000_metrics_diff_num_datapoints.csv",
        "18000": "vit_s16_18000_metrics_diff_num_datapoints.csv",
        "20000": "vit_s16_metrics_more_vits.csv",
    },
    "ViT_T16": {
        "2000": "vit_t16_2000_metrics_diff_num_datapoints.csv",
        "4000": "vit_t16_4000_metrics_diff_num_datapoints.csv",
        "6000": "vit_t16_6000_metrics_diff_num_datapoints.csv",
        "8000": "vit_t16_8000_metrics_diff_num_datapoints.csv",
        "10000": "vit_t16_10000_metrics_diff_num_datapoints.csv",
        "12000": "vit_t16_12000_metrics_diff_num_datapoints.csv",
        "14000": "vit_t16_14000_metrics_diff_num_datapoints.csv",
        "16000": "vit_t16_16000_metrics_diff_num_datapoints.csv",
        "18000": "vit_t16_18000_metrics_diff_num_datapoints.csv",
        "20000": "vit_t16_metrics_more_vits.csv",
    },
}
...
colormaps = {
    ...
    "ViT_S16": plt.cm.inferno,
    "ViT_T16": plt.cm.cividis,
}
...
# plt.tight_layout()
# plt.savefig(os.path.join(path, "diff_num_datapoints_r2_v2.pdf"), bbox_inches='tight')
...
#     ax.grid(True, linestyle="--", linewidth=0.4, alpha=0.5)
# plt.tight_layout()
# plt.savefig(os.path.join(path, "diff_num_datapoints_mse_v2.pdf"), bbox_inches='tight')
