...
def plot_metrics(models_info, title_prefix,):
    ...
    plt.legend(handles=legend_elements, fontsize=12, title="Run", frameon=False)
    plt.xlabel("Epochs",fontsize=12)
    plt.ylabel(r"$1-R^2$ Score",fontsize=13)
    # plt.ylim(0.99, 1.001)
    # plt.xlim(left=110)
    plt.xscale('log')
    plt.yscale('log')
...
plot_metrics(load_models_info(run_fits_patch_sizes,"viridis"), "ViT Different Patch Sizes")
...
plot_metrics_vit(load_models_info(runs_1000_epochs,"viridis"), "1000 Epochs Runs ViT")
